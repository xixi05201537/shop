...
import { FileImage, FileText, Home, Images, LogOut, Mail, Package, ReceiptText, Settings, Sparkles, WalletCards } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/payment-requests", label: "付款单", icon: WalletCards },
